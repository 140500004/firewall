                ...
                <div class="tab-content">
                    <div id="perfil" class="tab-pane fade in active">
                        ...
                        <div class="form-group">
                            ...
                            {{ Form::label('nome do usuario') }}
                            {{ Form::text('nome', null, ['class' => 'form-control dis', 'placeholder' => 'Nome do Usuario', 'id' => 'usuario', "readonly" => "readonly", 'required' => 'required']) }}
                        </div>

                        <div class="form-group">
                            {{ Form::label('nome de login') }}
                            {{ Form::text('login', null, ['class' => 'form-control', 'placeholder' => 'Nome do Login', 'id' => 'login', "readonly" => "readonly", 'required' => 'required']) }}
                        </div>

                        <div class="form-group">
                        {{ Form::label('nova senha') }}
                            <input class="form-control" placeholder="Nova Senha" name="senha" required="required" type="password" id="senha">
                        </div>

                        <div class="form-group">
                        {{ Form::label('Confirme a Senha') }}
                            <input class="form-control" placeholder="Confirme a Senha" name="senhac" required="required" type="password" id="senhaC">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input name="status" id="status" type="checkbox" value="I">
                        </div>
...
<!-- Regras para o Usuario - Inicio -->
<div id="ModalRegrasUsuario" class="modal" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button class="close" data-dismiss="modal">&times;</button>
                <h4>Regras para o Usuario</h4>
            </div>
            <div class="modal-body">
                {{ Form::open(array('url' => 'regras')) }}
                <div class="input-group">
                ...
                <div class="form-group">
                    ...
                    @if(empty($Usuarios))
                        <div class="alert alert-danger"> Você não tem nenhum grupo cadastrado, faça primeiro o cadastro do grupo. </div>
                    @else
                        <select name="id_usuario" required="required" class="form-control">
                            <option> Selecionar...</option>
